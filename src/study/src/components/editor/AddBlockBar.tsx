    ...
    <div className="border border-black bg-white p-3">
      <div className="flex flex-wrap gap-2">
        ...
        <button
          ...
          className="ml-auto border border-black bg-black px-3 py-2 text-sm text-white"
        >
          Шаблоны
        </button>
      </div>
