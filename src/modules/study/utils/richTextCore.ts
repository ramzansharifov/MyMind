...
import { findMaterialNodeByLinkTitle } from "./internalLinks";
import { saveInternalLinkReturnTarget } from "./internalNavigationHistory";
  ...
  textNodes.forEach((textNode) => {
    ...
    while ((match = regex.exec(value)) !== null) {
      ...
      if (target) {
        ...
        button.className = "study-inline-link";
        ...
        span.className = "study-inline-link broken";
